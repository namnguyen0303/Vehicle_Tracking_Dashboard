...
Step-by-step walkthrough using pgAdmin to set up the database and link it to your project.

---

## Before You Start

- **PostgreSQL** installed (with **PostGIS** via Stack Builder)
- **pgAdmin 4** installed (usually comes with PostgreSQL)
- Your `postgres` password (set during PostgreSQL install)
